...
const translations = {
  en: {
    ...
    forgotPasswordSubtitle: "Enter your registered email to receive a 6-digit confirmation code.",
    sendResetCode: "Send Verification Code",
    sendingCode: "Sending code...",
    codeSentToEmail: "A 6-digit verification code was sent to",
    enterResetCode: "Enter 6-Digit Code",
    resetCodePlaceholder: "e.g. 482910",
    newPassword: "New Password",
    enterNewPassword: "Enter new strong password",
  ...
  es: {
    ...
    forgotPasswordSubtitle: "Introduce tu correo para recibir un código de confirmación de 6 dígitos.",
    sendResetCode: "Enviar código de verificación",
    sendingCode: "Enviando código...",
    codeSentToEmail: "Se envió un código de 6 dígitos a",
    enterResetCode: "Introduce el código de 6 dígitos",
    resetCodePlaceholder: "ej. 482910",
    newPassword: "Nueva contraseña",
    enterNewPassword: "Escribe tu nueva contraseña",
    confirmNewPassword: "Confirma la nueva contraseña",
    resetPasswordButton: "Restablecer contraseña e iniciar sesión",
    resettingPassword: "Restableciendo contraseña...",
    passwordResetSuccess: "¡Contraseña restablecida con éxito! Ya puedes iniciar sesión.",
  ...
  fr: {
    ...
    forgotPasswordSubtitle: "Entrez votre e-mail pour recevoir un code de confirmation à 6 chiffres.",
    sendResetCode: "Envoyer le code de vérification",
    sendingCode: "Envoi du code...",
    codeSentToEmail: "Un code à 6 chiffres a été envoyé à",
    enterResetCode: "Entrez le code à 6 chiffres",
    resetCodePlaceholder: "ex. 482910",
    newPassword: "Nouveau mot de passe",
    enterNewPassword: "Entrez le nouveau mot de passe",
    confirmNewPassword: "Confirmez le nouveau mot de passe",
    resetPasswordButton: "Réinitialiser et se connecter",
  ...
  pt: {
    ...
    forgotPasswordSubtitle: "Introduza o seu e-mail para receber um código de confirmação de 6 dígitos.",
    sendResetCode: "Enviar código de verificação",
    sendingCode: "A enviar código...",
    codeSentToEmail: "Foi enviado um código de 6 dígitos para",
    enterResetCode: "Introduza o código de 6 dígitos",
    resetCodePlaceholder: "ex. 482910",
    newPassword: "Nova palavra-passe",
    enterNewPassword: "Introduza a nova palavra-passe",
    confirmNewPassword: "Confirme a nova palavra-passe",
    resetPasswordButton: "Redefinir palavra-passe e entrar",
    resettingPassword: "A redefinir...",
    passwordResetSuccess: "Palavra-passe redefinida com sucesso! Já pode iniciar sessão.",
    resendCode: "Reenviar código",
...
const extraTranslations = {
  en: {
    ...
    lockPastMonthsTitle: "Check & Balance Protection (Lock Past Months)",
    lockPastMonthsDesc: "Freeze past closed months to prevent accidental modifications or additions. Maintains financial integrity and balance across accounting periods.",
    pastMonthLockedAlert: "🔒 Check & Balance Protection: This month has been closed and locked. You cannot add new transactions to previous months while Check & Balance lock is active. You can adjust this in Settings if necessary.",
    pastMonthLockedReceipt: "🔒 Check & Balance Protection: Scanned receipt date belongs to a closed past month. New transactions cannot be added to closed periods.",
    pastMonthLockedDelete: "🔒 Check & Balance Protection: Transactions in previous closed months cannot be deleted to preserve financial audit integrity.",
    pastMonthLockedEdit: "🔒 Check & Balance Protection: Transactions in previous closed months cannot be modified to preserve financial audit integrity.",
    periodClosedBalanced: "Closed & Balanced Period",
    currentActivePeriod: "Current Active Period",
    locked: "Locked",
    enabled: "Enabled (Protected)",
    unlocked: "Unlocked",
    timeAndDateAnalysis: "Time & Date Spending Analysis",
    timelineGraph: "Date & Time Spending Curve",
    timeOfDayAnalysis: "Time-of-Day Distribution",
    dayOfWeekAnalysis: "Day-of-Week Patterns",
    peakSpendingTime: "Peak Spending Window",
    peakHour: "Peak Hour",
    morningSpend: "Morning (06:00 - 12:00)",
    afternoonSpend: "Afternoon (12:00 - 18:00)",
    eveningSpend: "Evening (18:00 - 23:00)",
    nightSpend: "Late Night (23:00 - 06:00)",
    cumulativeCurve: "Cumulative Spending Curve",
    incomeVsExpense: "Income vs Expenses",
    dailyBudgetLine: "Daily Limit Line",
    ...
    financialSummary: "Financial Health Summary",
    hourlyDistribution: "24-Hour Spending Distribution",
    weekdayVsWeekend: "Weekday vs Weekend",
    weekend: "Weekend",
    weekday: "Weekday",
    transactionAuditLog: "Date & Time Transaction Log",
    filterCategory: "Filter Category",
    allCategories: "All Categories",
    phoneNotificationsTitle: "Phone & SMS Daily Overspending Alerts",
    phoneNotificationsSubtitle: "Get instant SMS text alerts when your daily spending exceeds your set daily limit.",
    phoneNumberLabel: "Phone Number & Country Code",
    phoneNumberPlaceholder: "e.g. 612 345 678",
    selectCountryCode: "Country Code",
    fullNumberPreview: "International Dial Format",
    sendVerificationCode: "Send Verification Code",
    sendingCode: "Sending Code...",
    enterSmsCode: "Enter 6-Digit SMS Code",
    verifyAndSavePhone: "Verify & Activate Phone",
    verifyingCode: "Verifying...",
    phoneVerifiedBadge: "Verified & Active",
    enableSmsOverspendAlerts: "Send SMS Alerts when Daily Limit is Exceeded",
    enableSmsAlertsSub: "Automatically sends an SMS message if your daily expenses go over your daily limit.",
    sendTestSms: "Send Test SMS Alert",
    testSmsSuccess: "Test SMS alert sent successfully to your phone! ✓",
    disconnectPhone: "Disconnect Phone",
    changePhone: "Change Number",
    invalidPhoneNumber: "Please enter a valid phone number.",
    allBadges: "All",
    unlockedBadges: "Unlocked",
    lockedBadges: "In Progress",
    howToEarn: "How to Unlock",
    tapBadgeHint: "Tap any badge to inspect & take action",
    badgeCompleted: "Completed & Unlocked!",
    takeAction: "Go to Feature",
    progress: "Progress",
  },
  es: {
    ...
    timeAndDateAnalysis: "Análisis de Gastos por Tiempo y Fecha",
    timelineGraph: "Curva Temporal de Gastos",
    timeOfDayAnalysis: "Distribución por Franja Horaria",
    dayOfWeekAnalysis: "Patrones por Día de la Semana",
    peakSpendingTime: "Franja de Mayor Gasto",
    peakHour: "Hora Pico",
    morningSpend: "Mañana (06:00 - 12:00)",
    afternoonSpend: "Tarde (12:00 - 18:00)",
    eveningSpend: "Noche (18:00 - 23:00)",
    nightSpend: "Madrugada (23:00 - 06:00)",
    cumulativeCurve: "Curva Acumulada de Gastos",
    incomeVsExpense: "Ingresos vs Gastos",
    dailyBudgetLine: "Límite Diario",
    ...
    endDate: "Fecha Final",
    avgPerTransaction: "Promedio / Transacción",
    totalTransactions: "Total de Transacciones",
    printReport: "Imprimir / Guardar Informe PDF",
    financialSummary: "Resumen de Salud Financiera",
    hourlyDistribution: "Distribución de Gastos 24 Horas",
    weekdayVsWeekend: "Entre Semana vs Fin de Semana",
    weekend: "Fin de Semana",
    weekday: "Entre Semana",
    transactionAuditLog: "Registro de Transacciones con Fecha y Hora",
    filterCategory: "Filtrar por Categoría",
    allCategories: "Todas las Categorías",
    phoneNotificationsTitle: "Alertas por SMS y Teléfono de Gastos Diarios",
    phoneNotificationsSubtitle: "Recibe alertas por SMS al instante cuando tus gastos diarios superen tu límite establecido.",
    phoneNumberLabel: "Número de Teléfono y Código de País",
    phoneNumberPlaceholder: "ej. 612 345 678",
    selectCountryCode: "Código de País",
    fullNumberPreview: "Formato Internacional",
    sendVerificationCode: "Enviar Código de Verificación",
    sendingCode: "Enviando Código...",
    enterSmsCode: "Introduce el Código SMS de 6 Dígitos",
    verifyAndSavePhone: "Verificar y Activar Teléfono",
    verifyingCode: "Verificando...",
    phoneVerifiedBadge: "Verificado y Activo",
    enableSmsOverspendAlerts: "Enviar Alertas SMS al Superar el Límite Diario",
    enableSmsAlertsSub: "Envía un mensaje SMS automático si tus gastos diarios superan tu límite diario.",
    sendTestSms: "Enviar SMS de Prueba",
    testSmsSuccess: "¡SMS de prueba enviado con éxito a tu teléfono! ✓",
    disconnectPhone: "Desconectar Teléfono",
    changePhone: "Cambiar Número",
    phoneConnectedSuccess: "¡Teléfono verificado y alertas SMS configuradas! ✓",
    phoneDisconnectedSuccess: "Teléfono desconectado.",
    invalidPhoneNumber: "Introduce un número de teléfono válido.",
    allBadges: "Todos",
    unlockedBadges: "Desbloqueados",
    lockedBadges: "En progreso",
    howToEarn: "Cómo desbloquear",
    tapBadgeHint: "Toca cualquier medalla para ver detalles y accesos rápidos",
    badgeCompleted: "¡Completado y Desbloqueado!",
    takeAction: "Ir a la función",
    progress: "Progreso",
  },
  fr: {
    ...
    receiptScannerTitle: "Scanner de Reçus IA", dragDropReceipt: "Importez une photo de votre reçu", scanningReceipt: "Analyse et extraction IA en cours...", extractedDetails: "Données extraités du reçu", merchant: "Commerce", addToTransactions: "Ajouter aux transactions",
    ...
    timeAndDateAnalysis: "Analyse des Dépenses par Heure et Date",
    timelineGraph: "Courbe des Dépenses dans le Temps",
    timeOfDayAnalysis: "Répartition par Moment de la Journée",
    dayOfWeekAnalysis: "Tendances par Jour de la Semaine",
    peakSpendingTime: "Créneau de Dépense Maximale",
    peakHour: "Heure de Pointe",
    morningSpend: "Matin (06:00 - 12:00)",
    afternoonSpend: "Après-midi (12:00 - 18:00)",
    eveningSpend: "Soir (18:00 - 23:00)",
    nightSpend: "Nuit (23:00 - 06:00)",
    cumulativeCurve: "Courbe de Dépense Cumulée",
    incomeVsExpense: "Revenus vs Dépenses",
    dailyBudgetLine: "Ligne de Limite Journalière",
    ...
    endDate: "Date de Fin",
    avgPerTransaction: "Moyenne / Transaction",
    totalTransactions: "Total des Transactions",
    printReport: "Imprimer / Exporter Rapport PDF",
    financialSummary: "Bilan de Santé Financière",
    hourlyDistribution: "Répartition des Dépenses sur 24h",
    weekdayVsWeekend: "Semaine vs Week-end",
    weekend: "Week-end",
    weekday: "Semaine",
    transactionAuditLog: "Historique Détaillé avec Date et Heure",
    filterCategory: "Filtrer par Catégorie",
    allCategories: "Toutes les Catégories",
    phoneNotificationsTitle: "Alertes SMS de Dépassement Quotidien",
    phoneNotificationsSubtitle: "Recevez des alertes SMS instantanées lorsque vos dépenses quotidiennes dépassent votre limite journalière.",
    phoneNumberLabel: "Numéro de Téléphone & Indicatif Pays",
    phoneNumberPlaceholder: "ex. 6 12 34 56 78",
    selectCountryCode: "Indicatif Pays",
    fullNumberPreview: "Format International",
    sendVerificationCode: "Envoyer le Code de Vérification",
    sendingCode: "Envoi du Code...",
    enterSmsCode: "Entrez le Code SMS à 6 Chiffres",
    verifyAndSavePhone: "Vérifier & Activer le Téléphone",
    verifyingCode: "Vérification...",
    phoneVerifiedBadge: "Vérifié & Actif",
    enableSmsOverspendAlerts: "Envoyer des Alertes SMS en cas de Dépassement Journalier",
    enableSmsAlertsSub: "Envoie un SMS automatique si vos dépenses quotidiennes dépassent votre limite du jour.",
    sendTestSms: "Envoyer un SMS de Test",
    testSmsSuccess: "SMS de test envoyé avec succès sur votre téléphone ! ✓",
    disconnectPhone: "Déconnecter le Téléphone",
    changePhone: "Changer de Numéro",
    phoneConnectedSuccess: "Numéro vérifié et alertes SMS configurées ! ✓",
    phoneDisconnectedSuccess: "Numéro de téléphone déconnecté.",
    invalidPhoneNumber: "Veuillez entrer un numéro valide.",
    allBadges: "Tous",
    unlockedBadges: "Débloqués",
    lockedBadges: "En cours",
    howToEarn: "Comment débloquer",
    tapBadgeHint: "Appuyez sur un badge pour voir les détails et actions",
    badgeCompleted: "Complété et Débloqué !",
    takeAction: "Aller à la fonctionnalité",
  ...
  pt: {
    ...
    timeAndDateAnalysis: "Análise de Gastos por Hora e Data",
    timelineGraph: "Curva Temporal de Gastos",
    timeOfDayAnalysis: "Distribuição por Período do Dia",
    dayOfWeekAnalysis: "Padrões por Dia da Semana",
    peakSpendingTime: "Horário de Maior Despesa",
    peakHour: "Hora de Ponta",
    morningSpend: "Manhã (06:00 - 12:00)",
    afternoonSpend: "Tarde (12:00 - 18:00)",
    eveningSpend: "Noite (18:00 - 23:00)",
    nightSpend: "Madrugada (23:00 - 06:00)",
    cumulativeCurve: "Curva de Despesa Acumulada",
    incomeVsExpense: "Rendimentos vs Despesas",
    dailyBudgetLine: "Linha de Limite Diário",
    ...
    endDate: "Data Final",
    avgPerTransaction: "Média / Transação",
    totalTransactions: "Total de Transações",
    printReport: "Imprimir / Guardar Relatório PDF",
    financialSummary: "Resumo de Saúde Financeira",
    hourlyDistribution: "Distribuição de Despesas em 24h",
    weekdayVsWeekend: "Dias Úteis vs Fim de Semana",
    weekend: "Fim de Semana",
    weekday: "Dias Úteis",
    transactionAuditLog: "Registo Detalhado com Data e Hora",
    filterCategory: "Filtrar por Categoria",
    allCategories: "Todas as Categorias",
    phoneNotificationsTitle: "Alertas por SMS de Excesso Diário",
    phoneNotificationsSubtitle: "Receba alertas por SMS instantâneos quando os seus gastos diários ultrapassarem o seu limite diário.",
    phoneNumberLabel: "Número de Telefone & Indicativo Internacional",
    phoneNumberPlaceholder: "ex. 912 345 678",
    selectCountryCode: "Indicativo do País",
    fullNumberPreview: "Formato Internacional",
    sendVerificationCode: "Enviar Código de Verificação",
    sendingCode: "A enviar código...",
    enterSmsCode: "Introduza o Código SMS de 6 Dígitos",
    verifyAndSavePhone: "Verificar e Ativar Telefone",
    verifyingCode: "A verificar...",
    phoneVerifiedBadge: "Verificado e Ativo",
    enableSmsOverspendAlerts: "Enviar Alertas por SMS ao Ultrapassar o Limite Diário",
    enableSmsAlertsSub: "Envia um SMS automático se as suas despesas diárias ultrapassarem o limite diário.",
    sendTestSms: "Enviar SMS de Teste",
    testSmsSuccess: "SMS de teste enviado com sucesso para o seu telefone! ✓",
    disconnectPhone: "Desconectar Telefone",
    changePhone: "Alterar Número",
    phoneConnectedSuccess: "Telefone verificado e alertas SMS ativados! ✓",
    phoneDisconnectedSuccess: "Número de telefone desconectado.",
    invalidPhoneNumber: "Introduza um número de telefone válido.",
    allBadges: "Todos",
    unlockedBadges: "Desbloqueados",
    lockedBadges: "Em progresso",
    howToEarn: "Como desbloquear",
    tapBadgeHint: "Toque em qualquer medalha para ver detalhes e ações",
    badgeCompleted: "Concluído e Desbloqueado!",
    takeAction: "Ir para a funcionalidade",
    progress: "Progresso",
  },
};
